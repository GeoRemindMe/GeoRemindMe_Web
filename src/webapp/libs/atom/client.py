...
class AtomPubClient(object):
  ...
  def __init__(self, http_client=None, host=None,
    ...
    """
    self.http_client = http_client or libs.atom.http_core.ProxiedHttpClient()
    if host is not None:
      self.host = host
  ...
  def request(self, method=None, uri=None, auth_token=None,
    ...
    Args:
      method: The HTTP method as a string, usually one of 'GET', 'POST',
              'PUT', or 'DELETE'
      uri: The URI desired as a string or libs.atom.http_core.Uri.
      http_request:
  ...
  def modify_request(self, http_request):
    ...
    Args:
      http_request: An libs.atom.http_core.HttpRequest() (optional) If one is
                    not provided, a new HttpRequest is instantiated.

    Returns:
      An libs.atom.http_core.HttpRequest() with the User-Agent header set and
