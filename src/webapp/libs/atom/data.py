...
class Email(libs.atom.core.XmlElement):
  """The atom:email element."""
  _qname = ATOM_TEMPLATE % 'email'


class Uri(libs.atom.core.XmlElement):
  """The atom:uri element."""
  _qname = ATOM_TEMPLATE % 'uri'


class Person(libs.atom.core.XmlElement):
...
class Link(libs.atom.core.XmlElement):
...
class Generator(libs.atom.core.XmlElement):
...
class Text(libs.atom.core.XmlElement):
...
class Category(libs.atom.core.XmlElement):
...
class Date(libs.atom.core.XmlElement):
...
class FeedEntryParent(libs.atom.core.XmlElement, LinkFinder):
  ...
  def __init__(self, atom_id=None, text=None, *args, **kwargs):
    if atom_id is not None:
      self.id = atom_id
    libs.atom.core.XmlElement.__init__(self, text=text, *args, **kwargs)
...
class ExtensionElement(libs.atom.core.XmlElement):
  ...
  _BecomeChildElement = libs.atom.core.XmlElement._become_child
