...
class LinkFinder(libs.atom.data.LinkFinder):
...
class ExtendedProperty(libs.atom.core.XmlElement):
  ...
  def get_xml_blob(self):
    """Returns the XML blob as an libs.atom.core.XmlElement.
  ...
  def set_xml_blob(self, blob):
    ...
    Args:
      blob: str  or libs.atom.core.XmlElement representing the XML blob stored in
            the extendedProperty.
    """
    # Erase any existing extension_elements, clears the child nodes from the
    # extendedProperty.
    if isinstance(blob, libs.atom.core.XmlElement):
      self._other_elements = [blob]
    else:
      self._other_elements = [libs.atom.core.parse(str(blob))]

  SetXmlBlob = set_xml_blob


class GDEntry(libs.atom.data.Entry, LinkFinder):
...
class GDFeed(libs.atom.data.Feed, LinkFinder):
...
class BatchInterrupted(libs.atom.core.XmlElement):
...
class BatchFeed(GDFeed):
  ...
  def add_batch_entry(self, entry=None, id_url_string=None,
    ...
    Args:
      entry: BatchEntry, libs.atom.data.Entry, or another Entry flavor (optional)
    ...
    if entry is None and id_url_string is not None:
      entry = BatchEntry(id=libs.atom.data.Id(text=id_url_string))
...
class EntryLink(libs.atom.core.XmlElement):
...
class FeedLink(libs.atom.core.XmlElement):
...
class AdditionalName(libs.atom.core.XmlElement):
...
class Comments(libs.atom.core.XmlElement):
...
class EmailImParent(libs.atom.core.XmlElement):
  address = 'address'
  label = 'label'
  rel = 'rel'
  primary = 'primary'
...
class FamilyName(libs.atom.core.XmlElement):
...
class GivenName(libs.atom.core.XmlElement):
...
class NamePrefix(libs.atom.core.XmlElement):
...
class NameSuffix(libs.atom.core.XmlElement):
...
class FullName(libs.atom.core.XmlElement):
...
class Name(libs.atom.core.XmlElement):
  """The gd:name element.
...
class OrgDepartment(libs.atom.core.XmlElement):
...
class OrgJobDescription(libs.atom.core.XmlElement):
...
class OrgName(libs.atom.core.XmlElement):
...
class OrgSymbol(libs.atom.core.XmlElement):
...
class OrgTitle(libs.atom.core.XmlElement):
...
class Organization(libs.atom.core.XmlElement):
...
class When(libs.atom.core.XmlElement):
  """The gd:when element.
...
class OriginalEvent(libs.atom.core.XmlElement):
...
class PhoneNumber(libs.atom.core.XmlElement):
...
class PostalAddress(libs.atom.core.XmlElement):
...
class Rating(libs.atom.core.XmlElement):
...
class Recurrence(libs.atom.core.XmlElement):
...
class RecurrenceException(libs.atom.core.XmlElement):
...
class Reminder(libs.atom.core.XmlElement):
...
class Transparency(libs.atom.core.XmlElement):
...
class Agent(libs.atom.core.XmlElement):
...
class Postcode(libs.atom.core.XmlElement):
...
class FormattedAddress(libs.atom.core.XmlElement):
...
class StructuredPostalAddress(libs.atom.core.XmlElement):
...
class Where(libs.atom.core.XmlElement):
...
class Money(libs.atom.core.XmlElement):
  """Describes money"""
