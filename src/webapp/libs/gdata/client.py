...
import re
import libs.atom.client
import libs.atom.core
import libs.atom.http_core
...
def error_from_response(message, http_response, error_class,
  ...
  error.body = body
  error.headers = libs.atom.http_core.get_headers(http_response)
  return error
...
class GDClient(libs.atom.client.AtomPubClient):
  ...
  to use libs.gdata.gauth.AuthSubToken.from_url to obtain the token after the
  ...
  def request(self, method=None, uri=None, auth_token=None,
    ...
    Args:
      ...
      auth_token: An object which sets the Authorization HTTP header in its
                  ...
                  libs.gdata.gauth.ClientLoginToken and libs.gdata.gauth.AuthSubToken
                  among others.
    ...
    Returns:
      ...
      libs.atom.core.parse.
    """
    if isinstance(uri, (str, unicode)):
      uri = libs.atom.http_core.Uri.parse_uri(uri)
    ...
    response = libs.atom.client.AtomPubClient.request(self, method=method,
    ...
    if response.status == 200 or response.status == 201:
      if converter is not None:
        ...
        if self.api_version is not None:
          return libs.atom.core.parse(response.read(), desired_class,
  ...
  def request_client_login_token(
      ...
      auth_url=libs.atom.http_core.Uri.parse_uri(
          'https://www.google.com/accounts/ClientLogin'),
      captcha_token=None, captcha_response=None):
    service = service or self.auth_service
    # Set the target URL.
    http_request = libs.atom.http_core.HttpRequest(uri=auth_url, method='POST')
    http_request.add_body_part(
        libs.gdata.gauth.generate_client_login_request_body(email=email,
    ...
    if response.status == 200:
      token_string = libs.gdata.gauth.get_client_login_token_string(response_body)
      if token_string is not None:
        return libs.gdata.gauth.ClientLoginToken(token_string)
      else:
        raise ClientLoginTokenMissing(
            'Recieved a 200 response to client login request,'
            ' but no token was present. %s' % (response_body,))
    elif response.status == 403:
      captcha_challenge = libs.gdata.gauth.get_captcha_challenge(response_body)
  ...
  def client_login(self, email, password, source, service=None,
    ...
    Args:
      ...
      service: str The service code for the service you would like to access.
               ...
               list see
               http://code.google.com/apis/gdata/faq.html#clientlogin
               If you are using a subclass of the libs.gdata.client.GDClient, the
  ...
  def upgrade_token(self, token=None, url=libs.atom.http_core.Uri.parse_uri(
    ...
    Args:
      token: libs.gdata.gauth.AuthSubToken or libs.gdata.gauth.SecureAuthSubToken
      ...
      url: str or libs.atom.http_core.Uri (optional) The URL to which the token
          upgrade request should be sent. Defaults to:
          https://www.google.com/accounts/AuthSubSessionToken

    Returns:
      The upgraded libs.gdata.gauth.AuthSubToken object.
    """
    ...
    if not isinstance(token, libs.gdata.gauth.AuthSubToken):
      raise UnableToUpgradeToken(
          'Cannot upgrade the token because it is not an AuthSubToken object.')
    http_request = libs.atom.http_core.HttpRequest(uri=url, method='GET')
  ...
  def revoke_token(self, token=None, url=libs.atom.http_core.Uri.parse_uri(
  ...
  def get_oauth_token(self, scopes, next, consumer_key, consumer_secret=None,
                      ...
                      url=libs.gdata.gauth.REQUEST_TOKEN_URL):
    ...
    Args:
      scopes: list of strings or libs.atom.http_core.Uri objects which specify the
      ...
      next: str or libs.atom.http_core.Uri object, The URL which the user's browser
    ...
    if rsa_private_key is not None:
      http_request = libs.gdata.gauth.generate_request_for_request_token(
          consumer_key, libs.gdata.gauth.RSA_SHA1, scopes,
          rsa_key=rsa_private_key, auth_server_url=url, next=next)
    elif consumer_secret is not None:
      http_request = libs.gdata.gauth.generate_request_for_request_token(
          consumer_key, libs.gdata.gauth.HMAC_SHA1, scopes,
    ...
    if rsa_private_key is not None:
      return libs.gdata.gauth.rsa_token_from_body(response_body, consumer_key,
                                             rsa_private_key,
                                             libs.gdata.gauth.REQUEST_TOKEN)
    elif consumer_secret is not None:
      return libs.gdata.gauth.hmac_token_from_body(response_body, consumer_key,
                                              consumer_secret,
                                              libs.gdata.gauth.REQUEST_TOKEN)
  ...
  def get_access_token(self, request_token,
                       url=libs.gdata.gauth.ACCESS_TOKEN_URL):
    ...
    """
    http_request = libs.gdata.gauth.generate_request_for_access_token(
    ...
    return libs.gdata.gauth.upgrade_to_access_token(request_token, response_body)
  ...
  def modify_request(self, http_request):
    ...
    """
    http_request = libs.atom.client.AtomPubClient.modify_request(self,
                                                            http_request)
    if self.api_version is not None:
  ...
  def get_feed(self, uri, auth_token=None, converter=None,
               desired_class=libs.gdata.data.GDFeed, **kwargs):
  ...
  def get_entry(self, uri, auth_token=None, converter=None,
                desired_class=libs.gdata.data.GDEntry, etag=None, **kwargs):
    http_request = libs.atom.http_core.HttpRequest()
  ...
  def delete(self, entry_or_uri, auth_token=None, force=False, **kwargs):
    ...
    if isinstance(entry_or_uri, (str, unicode, libs.atom.http_core.Uri)):
...
class GDQuery(libs.atom.http_core.Uri):
...
class ResumableUploader(object):
  ...
  def __init__(self, client, file_handle, content_type, total_file_size,
    ...
    Args:
      client: libs.gdata.client.GDClient A Google Data API service.
      ...
      desired_class: object (optional) The type of libs.gdata.data.GDEntry to parse
    ...
    self.desired_class = desired_class or libs.gdata.data.GDEntry
  ...
  def _init_session(self, resumable_media_link, entry=None, headers=None,
    ...
    Args:
      ...
      entry: A (optional) libs.gdata.data.GDEntry containging metadata to create the 
          upload from.
  ...
  def update_file(self, entry_or_resumable_edit_link, headers=None, force=False,
    ...
    Args:
      entry_or_resumable_edit_link: object or string A libs.gdata.data.GDEntry for
      ...
      force boolean (optional) True to force an update and set the If-Match
          ...
          libs.gdata.data.GDEntry object, its etag value is used. Otherwise this
    ...
    if isinstance(entry_or_resumable_edit_link, libs.gdata.data.GDEntry):
