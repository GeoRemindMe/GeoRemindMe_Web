...
import libs.gdata
import libs.gdata.calendar
import libs.gdata.service
...
class ContactsService(libs.gdata.service.GDataService):
  ...
  def __init__(self, email=None, password=None, source=None,
    ...
    Args:
      ...
      **kwargs: The other parameters to pass to libs.gdata.service.GDataService
          constructor.
    """

    self.contact_list = contact_list
    libs.gdata.service.GDataService.__init__(
  ...
  def GetContactsFeed(self, uri=None):
    ...
    return self.Get(uri, converter=libs.gdata.contacts.ContactsFeedFromString)

  def GetContact(self, uri):
    return self.Get(uri, converter=libs.gdata.contacts.ContactEntryFromString)
  ...
  def CreateContact(self, new_contact, insert_uri=None, url_params=None,
    ...
    return self.Post(new_contact, insert_uri, url_params=url_params,
                     ...
                     converter=libs.gdata.contacts.ContactEntryFromString)
  ...
  def GetGroupsFeed(self, uri=None):
    ...
    return self.Get(uri, converter=libs.gdata.contacts.GroupsFeedFromString)
  ...
  def CreateGroup(self, new_group, insert_uri=None, url_params=None,
    ...
    return self.Post(new_group, insert_uri, url_params=url_params,
        escape_params=escape_params,
        converter=libs.gdata.contacts.GroupEntryFromString)
  ...
  def ChangePhoto(self, media, contact_entry_or_url, content_type=None, 
    ...
    """
    if isinstance(contact_entry_or_url, libs.gdata.contacts.ContactEntry):
  ...
  def GetProfilesFeed(self, uri=None):
    ...
    return self.Get(uri,
                    converter=libs.gdata.contacts.ProfilesFeedFromString)
  ...
  def GetProfile(self, uri):
    ...
    """
    return self.Get(uri,
                    converter=libs.gdata.contacts.ProfileEntryFromString)
  ...
  def ExecuteBatch(self, batch_feed, url,
                   converter=libs.gdata.contacts.ContactsFeedFromString):
...
class ContactsQuery(libs.gdata.service.Query):
  ...
  def __init__(self, feed=None, text_query=None, params=None,
    ...
    libs.gdata.service.Query.__init__(self, feed=self.feed, text_query=text_query,
...
class GroupsQuery(libs.gdata.service.Query):
...
class ProfilesQuery(libs.gdata.service.Query):
