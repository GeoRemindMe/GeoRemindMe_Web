...
urlpatterns = patterns('facebookApp.views',
    ...
    url(r'^(?i)settings/$', 'profile_settings', {}, 'fb_profile_settings'),
    url(r'^(?i)settings/edit/$', 'edit_settings', {}, 'fb_edit_settings'),
    url(r'^(?i)user/edit/$', 'edit_profile', {}, 'fb_edit_profile'),
    url(r'^(?i)user/(?P<username>[^/]*)/$', 'profile', {}, 'fb_public_profile'),
