...
import time
import datetime
import facebookApp.facebook as facebook
...
class FacebookMiddleware(object):
    ...
    def __init__(self, api_key=None, secret_key=None, app_name=None,
        ...
        self.api_key = api_key or settings.OAUTH['facebook']['app_key']
        self.secret_key = secret_key or settings.OAUTH['facebook']['app_secret']
