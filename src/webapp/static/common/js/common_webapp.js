...
$.fn.lavaLamp = function(o) {
    ...
    return this.each(function() {
        var me = $(this), noop = function(){},
            ...
            $li = $("li", this), curr = $("li.active-section", this)[0] //|| $($li[0]).addClass("current")[0];
 ...
 * Edited by hhkaos: lines: 24 & 25 DO NOT REPLACE BY MIN DEFAULT
        ...
        reversegeocode: function(options) {
            return this.each(function() {
                if (typeof(GClientGeocoder)!="undefined"){
                    ...
                    function getAddress(response) {
                        if (!response || response.Status.code != 200) {
                            ...
                            if(!place.address || !obj) {
                                ...
                                if(options.callback)
                                    options.callback(place.address);
                            }
                        }
                    }
                    ...
                    console.log("Error no se ha cargado correctamente la API de Google Maps");
