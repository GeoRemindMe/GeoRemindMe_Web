...
class OAUTH_Server(oauth2.Server):
    ...
    def token_requested(self, request):
        ...
        try:
            ...
            return self.backend.fetch_request_token(oauthRequest, oauthConsumer, callback)
        except:
            return self.backend.fetch_request_token(oauthRequest, oauthConsumer, None)
    ...
    def access_token_requested(self, request):
        ...
        accessToken = self.backend.fetch_access_token(oauthToken, oauthConsumer)
        return accessToken
